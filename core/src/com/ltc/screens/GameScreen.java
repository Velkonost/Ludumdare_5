...
//        backgroundMusic = game.getManager().get("audio/song.ogg");
    ...
    public void show() {
      ...
      //Horizontal
        ...
        walls.add(factory.createWall(world, new Vector2(9.4f, 12.5f), 400f, 10f, -205f, 0f, "wall2", 2.2f, 0.1f));
        walls.add(factory.createWall(world, new Vector2(11.6f, 12.5f), 400f, 10f, -205f, 0f, "wall2", 2.2f, 0.1f));
        walls.add(factory.createWall(world, new Vector2(13.8f, 12.5f), 400f, 10f, -205f, 0f, "wall2", 2.2f, 0.1f));
        walls.add(factory.createWall(world, new Vector2(16f, 12.5f), 400f, 10f, -205f, 0f, "wall2", 2.2f, 0.1f));
        walls.add(factory.createWall(world, new Vector2(7.2f, 18.6f), 400f, 10f, -205f, 0f, "wall2", 2.2f, 0.1f));
        walls.add(factory.createWall(world, new Vector2(9.2f, 14.5f), 400f, 10f, -205f, 0f, "wall2", 2.2f, 0.1f));
